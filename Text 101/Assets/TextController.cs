using UnityEngine;
// to bring the userinterface inforamtion
// if not it will not recognize it
using UnityEngine.UI;
using System.Collections;

public class TextController : MonoBehaviour {
	///  make a varible text of Type Text to all the variable.
	/// The problem is that there should be a attchment here 
	public Text text;
